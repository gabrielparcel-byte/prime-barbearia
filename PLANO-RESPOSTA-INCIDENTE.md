...
- [ ] Nunca commitar a chave `service_role` do Supabase no código (só a chave `anon`/`publishable` é segura pra ficar no front-end — ver `index_9.html`)
